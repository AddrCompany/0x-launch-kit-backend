...
exports.OrderWatchersFactory = {
    build(lifeCycleEventCallback) {
        const adapter = config_1.USE_MESH
            ? exports.OrderWatchersFactory.buildMesh(lifeCycleEventCallback)
            : exports.OrderWatchersFactory.buildOrderWatcher(lifeCycleEventCallback);
        return adapter;
    },
    buildOrderWatcher(lifeCycleEventCallback) {
    ...
    buildMesh(lifeCycleEventCallback) {
        const adapter = new mesh_adapter_1.MeshAdapter(lifeCycleEventCallback);
        return adapter;
    },
};
